...
assert.match(html, /<link rel="stylesheet" href="\.\/assets\/css\/main\.css\?v=11">/);
assert.match(html, /<script src="\.\/assets\/js\/site-config\.js\?v=11" defer><\/script>/);
assert.match(html, /<script src="\.\/assets\/js\/main\.js\?v=11" defer><\/script>/);
